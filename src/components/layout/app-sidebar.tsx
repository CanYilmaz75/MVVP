...
export function AppSidebar({
  ...
  return (
    <aside className="z-10 hidden w-64 shrink-0 flex-col border-r border-border bg-white px-5 py-8 shadow-[8px_0_24px_rgba(10,10,15,0.035)] md:flex xl:w-72 xl:px-6">
