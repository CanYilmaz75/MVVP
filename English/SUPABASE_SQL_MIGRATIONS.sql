...
-- CAREVO MVP
-- Production-minded baseline schema for controlled pilot deployment
-- Run in a migration workflow rather than manually editing production schema where possible.
...
-- =========================================================
-- Helper function to resolve current user's organisation
-- =========================================================
...
-- =========================================================
-- Optional trigger/function: auto-create profile stub
-- NOTE:
-- This part depends on your signup flow and may be adapted.
-- =========================================================
...
declare
  org_id uuid;
begin
  -- Creates a default organisation per new user if none is provided externally.
  insert into public.organisations (name, slug)
  values (
    coalesce(new.raw_user_meta_data->>'organisation_name', 'Default Organisation'),
    lower(replace(coalesce(new.email, gen_random_uuid()::text), '@', '-'))
  )
...
-- =========================================================
-- Seed example template (run separately if desired)
-- =========================================================
-- Example:
-- insert into public.note_templates (
--   organisation_id, name, specialty, note_type, schema_version, template_definition
-- )
-- values (
--   '<org-uuid>',
